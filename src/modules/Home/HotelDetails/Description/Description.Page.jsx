...
const DescriptionPage = ({ data }) => {
	return (
		...
		>
			...
			<Box sx={{ display: 'flex', gap: '4rem', alignItems: 'center', mb: '20px' }}>
				<Box sx={{ display: 'flex', gap: '.5rem', alignItems: 'center' }}>
					<Typography sx={{ fontSize: 18, fontWeight: 700, color: themeColors.black }}>Opened In:</Typography>
					<Typography sx={{ fontSize: 16, color: themeColors.black }}>{data?.year}</Typography>
				</Box>
				{/* <Box sx={{ display: "flex", gap: ".5rem", alignItems: "center" }}>
          <Typography
